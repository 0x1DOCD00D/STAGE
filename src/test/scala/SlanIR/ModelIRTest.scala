...
class ModelIRTest extends AnyFlatSpec with Matchers:
  behavior of "the model IR translation manager for SLAN constructs obtained from the original SLAN specification"

  it should "translate a model entry" in {
